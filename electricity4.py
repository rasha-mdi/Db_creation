...
try:
    ...
    CREATE TABLE IF NOT EXISTS meters(
        ...
        MPAN varchar(256) UNIQUE NOT NULL
    );
    ...
    uniquempans = df['MPAN'].drop_duplicates()
    mpanm_id = {}

    for mpan in uniquempans:
        cur.execute("INSERT INTO meters (MPAN) VALUES (%s) RETURNING m_id", (mpan,))
        m_id = cur.fetchone()[0]
        mpanm_id[mpan] = m_id
    ...
    for index, row in df.iterrows():
        ...
        m_id = mpanm_id[row['MPAN']]
        cur.execute("INSERT INTO consumption (date, m_id, consumed) VALUES (%s, %s, %s)",(row['ConsumptionDate'], m_id, rj))
